...
<html>
 <%
	...
	String QueryStringTable = "SELECT PTEC_Pkey,ser1.Usr_CompanyName,ser_yearSelect,ptec_AmountPaid,ptec_AmountDate,PTEC_UserKey FROM ptecservice ptec	INNER JOIN usrdetails ser1 ON ptec.PTEC_UserKey=ser1.Usr_Id INNER JOIN serviceselector isr ON ptec.PTEC_SerKey=isr.Ser_Id WHERE isr.Ser_YearSelect='2008-09';"; 		
	...
	while(Tableresultset .next())
	{
	    ...
	    for(int i=1;i<=6;i++) //replace 3 with the length of the columns
	    {
...
<br>
  ...
  <TABLE id ="customers" class="sortable" cellpadding="0" cellspacing="0" border="0">
	...
	<th class="sort-alpha"><h3>Amount Oaid Date</h3></th>
	</tr>
			</thead>
			<tbody>
			<% int i=1;
