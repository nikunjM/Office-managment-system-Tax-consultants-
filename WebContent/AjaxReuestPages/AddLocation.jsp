...
//if(lStatus=="Insert")
	...
	{
	InsertQuery="INSERT INTO dbo.Issue_Masters(Master_Names,Master_Type,Master_Status,Master_CreatedBy,Master_CreatedOn,Master_UpdatedBy,Master_UpdatedOn,Head_Version)VALUES('"+InsertValues+"','Location','1','"+lbean.getUserName()+"','"+Datetime+"','"+lbean.getUserName()+"','"+Datetime+"','1')";
	}
	else if(lStatus.equalsIgnoreCase("Update"))
	{
	InsertQuery="UPDATE Issue_Masters SET  Master_Names ='"+InsertValues+"',Master_Type='Location',Master_UpdatedBy ='"+lbean.getUserName()+"',Master_UpdatedOn = '"+Datetime+"',Head_Version = Head_Version+1 WHERE Dep_No ='"+Key+"'";
