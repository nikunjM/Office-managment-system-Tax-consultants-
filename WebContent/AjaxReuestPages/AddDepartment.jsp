...
//if(lStatus=="Insert")
	...
	{
	InsertQuery="INSERT INTO dbo.Issue_Masters(Master_Names,Master_Type,Master_Status,Master_CreatedBy,Master_CreatedOn,Master_UpdatedBy,Master_UpdatedOn,Head_Version)VALUES('"+InsertValues+"','Department','1','"+lbean.getUserName()+"','"+Datetime+"','"+lbean.getUserName()+"','"+Datetime+"','1')";
	System.out.println("Update name"+InsertQuery);
	}
	else if(lStatus.equalsIgnoreCase("Update"))
	{
	InsertQuery="UPDATE Issue_Masters SET  Master_Names ='"+InsertValues+"',Master_Type='Department',Master_UpdatedBy ='"+lbean.getUserName()+"',Master_UpdatedOn = '"+Datetime+"',Head_Version = Head_Version+1 WHERE Dep_No ='"+Key+"'";
	System.out.println("Update name"+InsertQuery);
	}
	else
	{
	InsertQuery="UPDATE Issue_Masters SET Master_Status='0',Master_UpdatedBy='"+lbean.getUserName()+"',Master_UpdatedOn='"+Datetime+"',Head_Version = Head_Version+1 WHERE dep_No='"+InsertValues+"'";
	}
try {
